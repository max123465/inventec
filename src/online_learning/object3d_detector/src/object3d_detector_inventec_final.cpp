...
*/
  ...
  filter_cloud.setInputCloud(pcl_pc);
  ...
  for (size_t i=0;  i<pc_indices->size(); ++i){
    //ROS_INFO("123123123");
    (*pcl_pc_filter)[i].x = pcl_pc->points[(*pc_indices)[i]].x;
    (*pcl_pc_filter)[i].y = pcl_pc->points[(*pc_indices)[i]].y;
    (*pcl_pc_filter)[i].z = pcl_pc->points[(*pc_indices)[i]].z;
